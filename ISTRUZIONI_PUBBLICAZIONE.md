...
4. Nel menu a sinistra vai su **Project Settings → API**. Copia due valori:
   - **Project URL** (es. `https://xxxxxxxx.supabase.co`): https://srpkzecstxfbzrlzzopd.supabase.co/rest/v1/
   - **anon public key** (una stringa lunga): eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNycGt6ZWNzdHhmYnpybHp6b3BkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODYxNjg4ODgsImV4cCI6MjEwMTc0NDg4OH0.yAhTKadZan4OxJTDm8Xc5PVXaUDdIaF0Jij9AvDgxxk
...
```bash
git remote add origin https://github.com/fabio38canova/ecocity-esg.git
git branch -M main
